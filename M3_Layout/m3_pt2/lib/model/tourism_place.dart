...
var tourismPlaceList = [
  ...
  TourismPlace(
    ...
    hari: 'Every Day',
    desk: 'Plaza Surabaya (atau biasa disebut dengan nama sebelumnya Delta Plaza) adalah pusat perbelanjaan di Surabaya. Mal ini didirikan pada tahun 1988 dengan penyewa - penyewa yang sudah terkenal sebagai perusahaan besar baik skala nasional maupun internasional',
    time: '09.00 - 22.00' ,
    cost: '5.000',
  ...
  TourismPlace(
    ...
    hari: 'Every Day',
    desk: 'Mal modern dengan pertokoan yang menjual pakaian, barang elektronik, mainan & makanan, plus restoran santai.',
    time: '09.00 - 22.00' ,
    cost: '5.000',
  ...
  TourismPlace(
    ...
    hari: 'Every Day',
    desk: 'Tugu Pahlawan adalah sebuah monumen yang menjadi markah tanah Kota Surabaya. Tinggi monumen ini adalah 41,15 meter dan berbentuk lingga atau paku terbalik. Tubuh monumen berbentuk lengkungan-lengkungan (canalures) sebanyak 10 lengkungan, dan terbagi atas 11 ruas. Tinggi, ruas dan canalures mengandung makna tanggal 10, bulan 11, tahun 1945. Suatu tanggal bersejarah, bukan hanya bagi penduduk Kota Surabaya, tetapi juga bagi seluruh Rakyat Indonesia',
    time: '09.00 - 15.30' ,
    cost: '30.000',
